...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle n;
    ros::ServiceClient client = n.serviceClient<tipsy::DrinkOrder>("drink_to_table");
  ...
  ros::Publisher coordinates_pub = n.advertise<tipsy::Coordinates>("coordinates_topic", 10);
